...
int main() {
    std::cout << "\n╔════════════════════════════════════════════════╗\n";
    std::cout << "║   BENCHMARK JOB C: Sizes 1100-2000           ║\n";
    std::cout << "║   (8 matrix sizes × 4 threads × 5 runs)      ║\n";
    std::cout << "╚════════════════════════════════════════════════╝\n\n";
    
    std::vector<int> sizes = {1100, 1200, 1300, 1400, 1500, 1600, 1800, 2000};
    ...
    std::ofstream file("results_sizes_1100_2000.csv");
    ...
    std::cout << "\n✓ Results saved: results_sizes_1100_2000.csv\n\n";
    return 0;
}

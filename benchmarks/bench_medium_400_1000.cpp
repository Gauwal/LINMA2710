...
int main() {
    std::cout << "\n╔════════════════════════════════════════════════╗\n";
    std::cout << "║   BENCHMARK JOB B: Sizes 400-1000            ║\n";
    std::cout << "║   (8 matrix sizes × 4 threads × 5 runs)      ║\n";
    std::cout << "╚════════════════════════════════════════════════╝\n\n";
    
    std::vector<int> sizes = {400, 500, 600, 700, 800, 900, 1000};
    ...
    std::ofstream file("results_sizes_400_1000.csv");
    ...
    std::cout << "\n✓ Results saved: results_sizes_400_1000.csv\n\n";
    return 0;
}

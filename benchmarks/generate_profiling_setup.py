#!/usr/bin/env python3
"""
Profiling helper script for LINMA2710 project.
Generates profiling commands and analysis templates.
"""

import os

def generate_profiling_guide():
    """Generate a guide for profiling on the cluster."""
...
"""
    ...
    with open("PROFILING_GUIDE.md", "w") as f:
        f.write(guide)
    
    print("✓ Generated: PROFILING_GUIDE.md")

def generate_submission_templates():
    """Generate submission script templates."""
...
#SBATCH --job-name=linma2710_bench
...
"""
    ...
    with open("submit_manneback.slurm", "w") as f:
        f.write(manneback)
    
    with open("submit_lyra.slurm", "w") as f:
        f.write(lyra)
    
    print("✓ Generated: submit_manneback.slurm")
    print("✓ Generated: submit_lyra.slurm")
    print()
    print("To submit jobs:")
    print("  $ sbatch submit_manneback.slurm")
    print("  $ sbatch submit_lyra.slurm")
    print()
...
def main():
    print("=" * 70)
    print("LINMA2710 Project - Profiling Setup")
    print("=" * 70)
    print()
    
    generate_profiling_guide()
    print()
    generate_submission_templates()

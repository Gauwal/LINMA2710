...
int main() {
    std::cout << "\n╔═══════════════════════════════════════════════════════════╗\n";
    std::cout << "║  COMPREHENSIVE BENCHMARK JOB C: Sizes 1100-2000          ║\n";
    ...
    // Save results
    std::ofstream file("comprehensive_results_1100_2000.csv");
    ...
    std::cout << "\n✓ Results saved: comprehensive_results_1100_2000.csv\n";
